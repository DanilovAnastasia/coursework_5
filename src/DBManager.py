...
class DBManager():
    ...
    def __init__(self, database_name: str):
        ...
        self.conn = psycopg2.connect(host="localhost", database=self.database_name, user="postgres", password="test123")
    ...
    def create_database(self):
        ...
        conn_temp = psycopg2.connect(host="localhost", database=self.database_name, user="postgres", password="test123")
    ...
    def create_tables(self):
        ...
        self.connect_to_database()
        self.cur.execute("DROP TABLE employers CASCADE")
        self.cur.execute("DROP TABLE vacancies CASCADE")
        # Запрос SQL
